...
(فایل <span dir="ltr">requirements.txt</span> را در ریشهٔ پروژه قرار دهید که شامل نام بسته‌ها و نسخه‌های مورد نیاز باشد، مثلاً: numpy, librosa, tensorflow, tensorflow-hub, scikit-learn, joblib
